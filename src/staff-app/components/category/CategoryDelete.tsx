    ...
    import { delCategoryValueById, getCategoryValueById } from "../../api/Category";
    ...
    export default function CategoryDelete({onSuccess, idCat} : CategoryEditProps) {
