...
import { delRoleValueById, getRoleValueById } from "../../api/Role";
...
export default function RoleDelete({onSuccess, idRole} : RoleEditProps) {
    ...
    const handleSave = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (validateForm()) {
            try {
                ...
                const result = await delRoleValueById(token, roleStaffId);
                if(result){
